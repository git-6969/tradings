...
if __name__ == "__main__":
    ...
    print("--- 옵션 코드 조회 ---")
    option_price = get_current_price(option_code_to_check)
    ...
    print("--- 선물 코드 조회 ---")
    future_price = get_current_price(future_code_to_check)
    ...
    print("--- 옵션 코드 조회 (우선순위 사용) ---")
    option_price_priority = get_current_price(option_code_to_check, use_priority=True)
    if option_price_priority is not None:
        print(f"{option_code_to_check} 현재가 (우선순위 사용): {option_price_priority}")
    else:
        print(f"{option_code_to_check} 가격 조회 실패 (우선순위 사용)")