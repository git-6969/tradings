...
class CpFutureMst:
    def __init__(self):
        self.objRq = win32com.client.Dispatch("Dscbo1.StockMst")   #### not used~~
    ...
    def request(self, code, retItem):
        ...
        retItem['현재가'] = self.objRq.GetHeaderValue(11)
        retItem['시가'] = self.objRq.GetHeaderValue(13)
        retItem['고가'] = self.objRq.GetHeaderValue(14)
        retItem['저가'] = self.objRq.GetHeaderValue(15)
